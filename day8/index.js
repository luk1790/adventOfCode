...
let oneChange = true;
    while (counter < localData.length && actualCommand.count === 0 ) {
      ...
      if (actualCommand.command === "acc") {
        ...
        console.log("%o - %o  %o %o", actualCommand, counter,counter + 1, localData.length);
        ...
        console.log("%o - %o  %o %o", actualCommand, counter, counter + actualCommand.number, localData.length);
        if (counter + actualCommand.number === localData.length - 1 && oneChange) {
          console.log('sd')
          localData[counter].count++;
          counter += actualCommand.number;
          oneChange = false
